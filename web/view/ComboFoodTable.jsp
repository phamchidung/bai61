<%-- 
    Document   : ComboFoodTable
    Created on : Aug 22, 2021, 7:19:47 PM
    Author     : HP
--%>
    ...
    <body>
        <div class="combo-food">
            ...
            <table class="table table-border-custom">
                ...
                <tbody>
                <c:forEach items="${requestScope.comboFoods}" var="o">
                    <tr>
                        <th scope="row">1</th>
                        <td>${o.name}</td>
            ...
            <p class="color-green">Tổng tiền combo món ăn: ${requestScope.totalComboFoodsMoney} VNĐ</p>
        </div>
